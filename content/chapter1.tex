...
Therefore, track-side balises are applied, whose sole purpose in \abr{ETCS} level two is to align a train's actual position and rectify any inaccuracies.
...
Aditionally, Hamming codes also allow to locate and correct errors in a bitstream.
