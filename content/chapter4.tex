...
Based on the applied system topology, the time that is required to publish and process a message with a certain payload size between two replicas via a \abr{DDS} topic is measured.
...
In a later section, the active hardware redundancy features will be reactivated to show the difference.
