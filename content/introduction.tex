...
At the same time, 41\% of all railway accidents were caused by human failures~\cite{TODO}, while \abr{SIL} 4 certified \abr{ATO} systems are possible.
Further, the standardization of signalling and control components in the \abr{ETCS} facilitated train operation across borders and heightened the significance of \abr{ATO} systems~\cite{YIN2017RNDofATO}.
