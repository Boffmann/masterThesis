...
Such situations could be managed by usage of a safety layer - for example applying \abr{ECC} on the tramsmitted data -  as well as by using a deterministic transport protocol~\cite{DeterministicTransport} such as TTEthernet or EtherCAT.
