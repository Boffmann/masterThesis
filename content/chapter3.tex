...
Afterwards,~\autoref{sec:ImpConsensusAlgorithm} describes a consensus algorithm that builds on \abr{DDS} to ensure that the redundant system can agree on a certain result for each processed input telegram.
