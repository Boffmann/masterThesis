...
As already stated, the actual system will be located within the context of the ~\gls*{ETCS}.
...
Such data is typically expressed as events and can be expressed using event topics.
...
However, without any further treatment, only crash faults can be tolerated for voters using a consensus algorithm.
