...
\begin{table}[htbp!]
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|X|X|X|X|}
			...
			\hline
			Reliability & BestEffort & Reliable & For rapidly and periodically changing states, it is ok if some data gets lost. For enduring state, however, data has to be transferred reliably. \\
			\hline
...
Recapped, \abr{TMR} suffers three significant challenges, which being:
