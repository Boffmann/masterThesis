...
The system should be able to receive a \abr{MA} that contains driving permissions.
...
Because the system is expected to operate in a time constrained environment, the input processing as well as leader election process are limitted by time restrictions.
These time restrictions can be enforced through \abr{DDS} concepts.
