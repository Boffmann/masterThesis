...
\newcommand{\hpititle}{Implementation and evaluation of DCPS communication in safety-critical and redundant applications by the example of an ETCS on-board system}
\newcommand{\hpititleother}{Umsetzung und Bewertung von DCPS Kommunikation in sicherheitskritischen und redundanten Anwendungen am Beispiel eines ECTS-Fahrzeugsystems} % <= das Studienreferat verlangt einen deutschen UND englischen Titel
